  ...
  return (
    <React.Fragment>
      ...
      <div className="flex justify-center items-center flex-col max-w-7xl font-Inter">
        ...
        <div className="flex flex-row items-center lg:flex-row gap-10">
          <div className="lg:order-2 -z-1 mt-10 lg:mt-2 flex  flex-col font-Inter rounded-2xl overflow-hidden bg-white max-w-5xl lg:max-w-none text-black lg:pb-10 pb-10 border-2 border-gray-200 shadow-md w-11/12 lg:w-1/3">
            <div className="hidden lg:block overflow-hidden lg:overflow-visible">
              <img src="https://htmlcolorcodes.com/assets/images/colors/gold-color-solid-background-1920x1080.png"></img>
            </div>
            <div className="pt-10 px-10">
              <h4 className="font-extrabold text-4xl lg:text-3xl text-center">1st<br></br>Prize</h4>
